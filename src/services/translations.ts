...
export const translations: any = {
  en: {
    ...
    wizard: {
      ...
      finish: { 
          ...
          secureWarning: 'Keep this key secret. It grants tunnel access.',
          key: 'Connection Key', 
  ...
  fa: {
    ...
    wizard: {
      ...
      finish: { 
          ...
          secureWarning: 'این کلید را محرمانه نگه دارید.',
          key: 'لایسنس کی', 
          doneButton: 'اتمام' 
      },
  ...
  // ... other languages (zh, ru) would follow similar pattern ...
};
